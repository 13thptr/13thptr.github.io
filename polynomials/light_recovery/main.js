...
class PolynomialRecoveryApp {
    ...
    startSearch() {
        ...
        this.worker = new Worker(URL.createObjectURL(new Blob([
            document.querySelector('script[src*="polynomial-search.js"]').textContent ||
            this.getWorkerCode()
    ...
    updateProgress(data) {
        ...
        if (data.total) {
            ...
            this.progressInfo.textContent = `Testing degree ${data.degree} polynomials...`;
        } else {
            // Infinite search
            ...
            this.progressInfo.textContent = `Infinite search - degree ${data.degree}`;
        }
